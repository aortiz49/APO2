...
public class Hurricane {
    ...
    public Hurricane(String pName, int pCategory, int pVelocity, double pEstimatedDamageCost,
        ...
        duration = (int)(Math.random()*(1-30)+30); 
        verifyInvariant();
    }
    ...
    public void modifyDuration(int pDuration) {
    	duration = pDuration;
    }
    
    
    public int compareByDuration(Hurricane pHurricane) {
    	int value;
    	if(duration < pHurricane.getDuration())
    		value = 1;
    	else if(duration == pHurricane.getDuration())
    		value = 0;
    	else
    		value = -1;
    	return value;
