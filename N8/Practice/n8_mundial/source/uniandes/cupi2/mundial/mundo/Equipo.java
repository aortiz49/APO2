...
public class Equipo implements Serializable {
    ...
    public void agregarJugador(Jugador j) throws ElementoExisteException {
        if (darJugador(j.darNombre()) != null)
            throw new ElementoExisteException(
                    "El jugador " + j.darNombre() + " ya existe en el equipo");
     ...
     */
    public void modificarInformacionJugador(String nombre, int edad, String posicion, double altura,
                                            double peso, double salario, String imagen) {
     ...
     * @return Retorna true si hay un jugador que aparece repetido dentro de la lista de
     * jugadores. Retorna false en caso contrario.
     */
