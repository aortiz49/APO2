...
public class Discotienda {
    ...
    public void agregarDisco(String nombreDiscoD, String artistaD, String generoD, String imagenD)
        ...
        if (darDisco(nombreDiscoD) != null)
            throw new ElementoExisteException(
                    "El disco " + nombreDiscoD + " ya existe en miDiscoTienda");
    ...
    public String venderListaCanciones(File archivoPedido, String rutaFactura)
        ...
        // Abre el archivo con el pedido. Si no existe, el constructor del flujo lanza la
        ...
        while (pedido != null) {
            // Separa los tres elementos del pedido (disco, artista y canci�n) verificando que el
            // formato pedido se cumpla
    ...
    public void salvarDiscotienda() throws PersistenciaException {
        try {
            ObjectOutputStream oos =
                    new ObjectOutputStream(new FileOutputStream(archivoDiscotienda));
