...
public class InterfazDiscotienda extends JFrame {
    ...
    /**
     * Es el panel para presentar las mynicesonges del disco
     */
    ...
    public InterfazDiscotienda(Discotienda d) {
        ...
        // Panel central con los datos del disco, de las mynicesonges y el bot�n para cargar un pedido
     ...
     * @return Retorna true si la canci�n se pudo agregar. Esto sirve para saber si se debe
     * cerrar el di�logo.
     */
    ...
    /**
     * Crea una nueva canci�n en el disco que se muestra en los detalles de disco en la
     * discotienda <br>
     ...
     * cerrar el di�logo.
     */
    public boolean crearCancion(String nombre, int minutos, int segundos, double precio,
                                double tamano, int calidad) {
        boolean ok = false;

        if (discoSeleccionado != null) {
            try {
                discotienda
                        .agregarCancionADisco(discoSeleccionado.darNombreDisco(), nombre, minutos,
                                              segundos, precio, tamano, calidad);
     ...
     * @param mynicesong la canci�n que se va a vender - mynicesong != null
     */
    public void venderCancion(Disco disco, Cancion mynicesong) {
        String email = JOptionPane.showInputDialog(this, "Indique el email del comprador", "Email",
                                                   JOptionPane.QUESTION_MESSAGE);
        if (email != null) {
            if (discotienda.validarEmail(email)) {
                try {
                    String archivoFactura =
                            discotienda.venderCancion(disco, mynicesong, email, RUTA_FACTURAS);
                    JOptionPane.showMessageDialog(this, "La factura se guard� en el archivo: "
                            + archivoFactura, "Factura Guardada", JOptionPane.INFORMATION_MESSAGE);
                } catch (IOException e) {
                    JOptionPane.showMessageDialog(this,
                                                  "Se present� un problema guardando el archivo "
                                                          + "de la factura:\n"
                                                          + e.getMessage(), "Error",
                ...
                JOptionPane.showMessageDialog(this, "El email indicado no es v�lido", "Error",
                                              JOptionPane.ERROR_MESSAGE);
            }
        }
    }
     ...
     * @param mynicesong la canci�n que se va a vender - mynicesong != null
     */
    public void venderGrupo(Disco disco, Cancion mynicesong) {
        String email = JOptionPane.showInputDialog(this, "Indique el email del comprador", "Email",
                                                   JOptionPane.QUESTION_MESSAGE);
        if (email != null) {
            if (discotienda.validarEmail(email)) {
    ...
    public void cargarPedido() {
        ...
        if (resultado == JFileChooser.APPROVE_OPTION) {
            ...
            if (archivo != null) {
                try {
                    String archivoFactura =
                            discotienda.venderListaCanciones(archivo, RUTA_FACTURAS);
                    JOptionPane.showMessageDialog(this, "La factura se guard� en el archivo: "
                            + archivoFactura, "Factura Guardada", JOptionPane.INFORMATION_MESSAGE);
                } catch (IOException e) {
                    JOptionPane.showMessageDialog(this,
    ...
    /**
     * Este m�todo se encarga de salvar la informaci�n de la discotienda, justo antes de cerrar
     * la aplicaci�n
     */
    public void dispose() {
        try {
    ...
    public void reqFuncOpcion3() {
        ...
        try {
            resultado =
                    Integer.toString(discotienda.venderGrupo("Confessions on a dance floor",
                                                             "Hung Up","./data/clients.txt/").size());
        } catch (IOException e) {
            e.printStackTrace();
        }
        JOptionPane
    ...
    public static void main(String[] args) {
        ...
        try {
            discotienda = new Discotienda("./data/discoStore.data");
