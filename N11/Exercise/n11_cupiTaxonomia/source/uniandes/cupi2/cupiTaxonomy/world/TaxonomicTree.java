...
public class TaxonomicTree {
     ...
     *
     * @param pTaxonNameFather Name of the taxon padre of the taxon to be added. pTaxonNameFather !=
    ...
    public void addTaxon(String pTaxonNameFather, int pTaxonLevelChild, String pTaxonNameChild)
        ...
        if (taxon == null) {
            Taxon padre = rootTaxon.findTaxonByLevel(pTaxonLevelChild - 1, pTaxonNameFather);
            padre.addSubTaxon(pTaxonLevelChild, pTaxonNameChild);
        }
        else {
