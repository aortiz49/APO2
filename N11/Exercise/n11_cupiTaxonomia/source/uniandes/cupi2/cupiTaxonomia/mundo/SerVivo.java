...
public class SerVivo implements Serializable {
     ...
     * <b> post: </b> El ser vivo se inicializó con los valores de nombre común, nombre
     * científico, características e imagen dados por parámetro.
     * @param pNombreComun Nombre común del ser vivo. pNombreComun != null y pNombreComun != "".
     * @param pNombreCientifico Nombre científico del ser vivo. pNombreCientifico != null y
     *                          pNombreCientifico != "".
     * @param pCaracteristicas Características del ser vivo. pCaracteristicas != null y
     *                         pCaracteristicas != "".
