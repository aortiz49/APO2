...
public class TaxonomicTreeInterface extends JFrame {
    ...
    /**
     * Shows the list of taxa in inorder.
     */
    public void showTaxaInOrder() {
        ArrayList taxa = tree.getTaxaInOrder();
        ShowTaxaDialogue dialogue = new ShowTaxaDialogue(taxa);
        dialogue.setLocationRelativeTo(this);
        dialogue.setVisible(true);
    }
    ...
    public void reqFuncOption1() {
        //String result = Integer.toString(tree.getTaxonRoot().getHeight());
        ArrayList<Taxon> list = tree.getTaxonsEndingWith("xxx");
        String name = "";
        for (int i = 0; i < list.size(); i++) {
            name += list.get(i).getName() + "\n";
        }
        JOptionPane.showMessageDialog(this, name, "Response", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public void reqFuncOption2() {
        // int result = tree.getNumLivingBeings();
        int result = tree.getTaxonRoot().getHeight();
