...
public class TaxaPanel extends JPanel implements TreeSelectionListener, ActionListener {
    ...
    /**
     * Constant that represents the command to show the list in in-order.
     */
    private final static String INORDER = "Inorder";
    ...
    /**
     * Button to show the taxa in in-order.
     */
