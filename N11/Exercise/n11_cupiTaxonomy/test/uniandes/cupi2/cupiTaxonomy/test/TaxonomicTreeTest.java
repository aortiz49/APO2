...
public class TaxonomicTreeTest {
    ...
    /**
     * Scenario 1: Crea un �rbol taxon�mico vac�o.
     */
    @Before
    ...
    /**
     * Scenario 2: Crea un �rbol taxon�mico a partir of un archivo.
     */
    @Test
    ...
    /**
     * Scenario 3: Crea un �rbol taxon�mico con taxa.
     */
    @Test
    ...
    /**
     * Scenario 4: Crea un �rbol taxon�mico con taxa y living beings.
     */
    @Test
    ...
    public void testTreeTaxonomico2() {
        setupScenario2();
        assertEquals("El �rbol no fue inicializado correctamente. Existen 6 taxa en el �rbol.",
                     17, arbolTaxonomico.getNumTaxa());
        assertEquals(
                "El �rbol no fue inicializado correctamente. Existen 2 living beings en el �rbol"
                        + ".", 2,
