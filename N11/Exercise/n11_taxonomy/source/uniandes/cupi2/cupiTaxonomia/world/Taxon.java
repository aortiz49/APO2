...
public class Taxon implements Serializable {
    ...
    public Taxon() {
        tipo = LUCA;
        nombre = "�ltimo antepasado com�n universal";
    ...
    public void buscarTaxonesPostorden(ArrayList<Taxon> pListaTaxones) {
        // TODO Parte1 PuntoG Complete el m�todo seg�n la documentaci�n dada.
    }
    ...
    public void buscarTaxonesNivel(int pTipo, ArrayList<String> pListaTaxones) {
        // TODO Parte1 PuntoH Complete el m�todo seg�n la documentaci�n dada.
    }
    ...
    public Taxon buscarTaxonNivel(int pTipo, String pNombreTaxon) {
        // TODO Parte1 PuntoI Complete el m�todo seg�n la documentaci�n dada.
        return null;
    }
     ...
     *
     * @param pTipo        Tipo del tax�n que se quiere eliminar. pTipo pertenece a {LUCA, DOMINIO,
    ...
    public void eliminarTaxon(int pTipo, String pNombreTaxon) {
        // TODO Parte1 PuntoJ Complete el m�todo seg�n la documentaci�n dada.
    }
