...
{
    /**
     * M�todo que permite escalar correctamente las im�genes de los seres vivos.
     ...
     * @param pIndice El �ndice de la celda. pIndice >= 0.
     * @param pSeleccionado Indica si la celda especificada est� seleccionada. pSelecciona != null.
