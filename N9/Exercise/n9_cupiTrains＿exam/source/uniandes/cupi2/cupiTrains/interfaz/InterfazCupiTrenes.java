...
public class InterfazCupiTrenes extends JFrame {
    ...
    public void reqFuncOpcion1() {
        Train train = cupiTrenes.darTrenMayorCantidadParadas();
        actualizarPaneles();
        String message = "";
        if(train != null)
        message = "El tren con mas paradas es el numero " + train.getId() + " con " + train.getTrainStops().size() + " paradas";

        else
        	message = "There are no trains in the system";
        
        JOptionPane.showMessageDialog(this,message , "Response",
                                      JOptionPane.INFORMATION_MESSAGE);
    }
...
/**
     ArrayList<Train> x = cupiTrenes.darTrenesConParadaEn("Miami");
     String trains = "";
     for (int i = 0; i < x.size(); i++) {
		trains += x.get(i).getId() + "\n";
	}
     ...
     **/
     ...
     Wagon newFirst = result.reverseWagons();
     Wagon current = newFirst;
     ...
     String m1 =  "Original: \n" + numbersRev + "\n" + "Inverted: \n" + numbers;
        ...
        JOptionPane.showMessageDialog(this, m1, "Response",
                                      JOptionPane.INFORMATION_MESSAGE);
        
        /**
        boolean x = cupiTrenes.getFirstTrain().existenVagonesMismaCantidadDisponibles();

        JOptionPane.showMessageDialog(this, x, "Response",
                                      JOptionPane.INFORMATION_MESSAGE);
                                      **/
    }
