...
public class DialogoAgregarTren extends JDialog implements ActionListener
{
    ...
    public DialogoAgregarTren( InterfazCupiTrenes pPrincipal, int pCantidadParadas )
    {
        ...
        panelAgregarParadas.setBorder( new TitledBorder( "Add train stops" ) );
        ...
        for( int i = 1; i <= cantidadParadas; i++ )
        {
            ...
            gbc.gridy++;
            gbc.gridwidth = 3;
            panelAgregarParadas.add( new JLabel( "Stop " + i ), gbc );
            panelAgregarParadas.add( new JLabel( ), gbc );
            gbc.gridy++;
    ...
    public void actionPerformed( ActionEvent pEvento )
    {
        ...
        if( AGREGAR.equals( comando ) )
        {
            try
            {
                ...
                for( int i = 0; i < cantidadParadas; i++ )
                {
                    ...
                    if( paradas[ i ].equals( "" ) )
                    {
                        ...
                        JOptionPane.showMessageDialog( this, "You must enter the names of all "
                                                               + "train stops"
                                                               + ".",
                    ...
                    {
                        JOptionPane.showMessageDialog( this, "The schedule of the bus stops must "
                                                               + "be ordered", "Add train",
            ...
            {
                JOptionPane.showMessageDialog( this, "The train id must be a numeric value..",
                                               "Add train", JOptionPane.ERROR_MESSAGE );
            }
            catch( Exception pE )
            {
                JOptionPane.showMessageDialog( this, pE.getMessage(), "Add train",
                                               JOptionPane.ERROR_MESSAGE );
            }
        }
    }
