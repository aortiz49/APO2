...
public class InterfazCentralPacientes extends JFrame {
     ...
     * @param formaAdicion El punto en el que va ser adicionado el paciente (de primero, último,
     *                     antes de otro paciente o después de otro paciente). formaAdicion
     *                     pertenece a
     *        {ANTES, DESPUES, COMIENZO, FINAL}
     * @param codigo El código del paciente con relación al cual se va a realizar la adición. Su
     *               valor sólo es considerado si formaAdicion es ANTES o DESPUES
     */
    ...
    /**
     * Si la lista de pacientes no está vacía muestra el diálogo para que el usuario seleccione
     * la forma en la que desea realizar la adición del paciente. Si la lista de
     ...
     * @param formaAdicion La forma en la que se va realizar la adición del paciente (de primero,
     *                    ultimo, antes de otro pacientes o despues de otro paciente). formaAdicion
     ...
     * @param laHistoriaClinica la historia clínica del paciente - laHistoriaClinica!=null &&
     *                          laHistoriaClinica!=""
     * @param elSexo El sexo del paciente.
     * @throws NoExisteException Si el código del paciente con relación al cual se va a realizar
     * la adición no se encuentra registrado
     * @throws YaExisteException
     * @throws YaExisteException Si ya existe un paciente con el código que se le va a asignar al
     * nuevo paciente
     */
    public void agregarPaciente(int formaAdicion, int codPaciente, int elCodigo, String elNombre,
                                String laClinica, String laHistoriaClinica, int elSexo)
            throws NoExisteException, YaExisteException {
    ...
    /**
     * Pide el código del paciente que se desea buscar, si lo encuentra muestra su información en
     * un dialogo. Si no se encuentra el paciente se muestra un mensaje indicándolo.
     */
        ...
        try {
            if (codigo != null) {
                ...
                if (paciente != null) {
                    ...
                    JOptionPane.showMessageDialog(this, "El paciente con código " + cod
                                                          + " no se encuentra registrado", "B"
                                                          + "úsqueda de Pacientes",
    ...
    /**
     * Pide la cédula del paciente que se desea eliminar, si lo elimina lo indica. Si no se
     * elimina el paciente se muestra un mensaje indicándolo.
     */
    public void eliminarPaciente() {
        ...
        try {
            if (codigo != null) {
                ...
                JOptionPane.showMessageDialog(this, "El paciente fue eliminado",
                                              "Eliminación Pacientes",
                                              JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "El código del paciente debe ser un valor numérico",
            ...
            JOptionPane.showMessageDialog(this, e.getMessage(), "Eliminación Pacientes",
    ...
    public void mostrarInformacionPaciente(Paciente paciente) {
        DialogoMostrarInformarcionPaciente dialogo =
                new DialogoMostrarInformarcionPaciente(this, paciente);
        dialogo.setLocationRelativeTo(this);
        dialogo.setVisible(true);
    }
    ...
    public void reqFuncOpcion1() {
        ...
        try {
            resultado = central.darPacienteMenorCodigo().darNombre();
        } catch (NoExisteException e) {
            e.printStackTrace();
        }
        JOptionPane
    ...
    public void reqFuncOpcion2() {
        ...
        String name = JOptionPane.showInputDialog(this, "Patient id to move to the front?");

        try {
            central.pasarAlComienzoPaciente(Integer.parseInt(name));
            refrescarListaPacientes();
        } catch (NoExisteException e) {
            e.printStackTrace();
        }
        ...
        JOptionPane
                .showMessageDialog(this, name, "Respuesta", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public void reqFuncOpcion3() {
        ...
        try {
            central.pasarAlFinalPacientes("Clínica del Country");
        } catch (NoExisteException e) {
            e.printStackTrace();
        }
