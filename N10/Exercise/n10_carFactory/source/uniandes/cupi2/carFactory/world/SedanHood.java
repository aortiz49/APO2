 ...
 */
public class SedanHood extends Body
{
     ...
     */
    public final static String IMAGE = "SedanHood.gif";

    /**
     * Constante que representa el tipo SedanHood.
     */
    public final static String TYPE = "SedanHood";
     ...
     */
    public SedanHood(int pX, int pY, Color pCarColor )
    {
     ...
     */
    public SedanHood(BufferedReader pBr ) throws Exception
    {
