...
public class EconomyRims extends Wheel {
    /**
     * Constante que representa el tipo EconomyRims.
     */
    public final static String TYPE = "EconomyRims";
     ...
     */
    public EconomyRims(int pX, int pY, Color pCarColor) {
     ...
     */
    public EconomyRims(BufferedReader pBr) throws Exception {
        super(pBr);
        tipo = TYPE;
    }
