 ...
 */
public class CompactTrunk extends Body {
     ...
     */
    public final static String IMAGE = "CompactTrunk.gif";

    /**
     * Constante que representa el tipo SedanHood.
     */
    public final static String TYPE = "CompactTrunk";
     ...
     */
    public CompactTrunk(int pX, int pY, Color pCarColor) {
     ...
     */
    public CompactTrunk(BufferedReader pBr) throws Exception {
